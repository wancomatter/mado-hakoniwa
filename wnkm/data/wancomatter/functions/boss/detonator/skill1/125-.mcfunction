...
execute if entity @s[tag=b1s1-sound] if score @s counter matches 125 as @e[tag=detonator] run data modify entity @s Attributes[{Name:"generic.movement_speed"}].Base set value 0.3d
