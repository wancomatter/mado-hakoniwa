...
execute positioned 0.0 0.8 0.0 rotated ~ 0 run summon armor_stand ^ ^ ^3.5 {Tags:["b1s21stand"],Marker:1b,Invisible:1b,NoGravity:1b}
...
execute if score #dummy dummy matches 1..23 rotated ~15 0 run function wancomatter:boss/detonator/skill21/bomb_around3