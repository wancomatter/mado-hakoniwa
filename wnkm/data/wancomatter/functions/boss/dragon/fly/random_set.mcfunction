...
data merge storage random: {min:-4000,max:4000}
execute if score #dragonBoss Cooldown1 matches 4000.. run scoreboard players set #dragonBoss dummy 8000
execute if score #dragonBoss Cooldown1 matches 4000.. store result storage random: max int 1 run scoreboard players operation #dragonBoss dummy -= #dragonBoss Cooldown1
execute if score #dragonBoss Cooldown1 matches ..-4000 run scoreboard players set #dragonBoss dummy -8000
execute if score #dragonBoss Cooldown1 matches ..-4000 store result storage random: min int 1 run scoreboard players operation #dragonBoss dummy -= #dragonBoss Cooldown1
...
#tellraw wnkm {"nbt":"pos","storage":"wnkm:boss"}
...
#tellraw wnkm {"nbt":"Pos","entity":"@s"}
#tellraw wnkm {"nbt":"Pos","entity":"@e[tag=dragon_init,limit=1]"}
#tellraw wnkm ""
