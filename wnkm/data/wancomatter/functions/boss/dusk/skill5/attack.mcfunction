scoreboard players set @s Cooldown5_max 50
...
tag @s add this
execute as @e[distance=..8,scores={maxHP=1..}] unless score @s teamNumber = @e[tag=this,limit=1] teamNumber run tag @s add hit
execute if entity @e[tag=hit,limit=1] as @e[tag=hit] at @s run function wancomatter:boss/dusk/skill5/dmg
tag @s remove this
