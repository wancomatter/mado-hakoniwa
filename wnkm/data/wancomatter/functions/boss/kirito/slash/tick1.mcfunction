...
execute if score @s subcounter matches 1 run scoreboard players remove @s Cooldown4_max 120
...
execute if score @s subcounter matches 6 run playsound minecraft:entity.player.attack.sweep master @a ~ ~ ~ 1.5 0.7
execute if score @s subcounter matches 6..8 run particle sweep_attack ^ ^1.3 ^1.0 0.3 0.1 0.3 0 5 force @a
