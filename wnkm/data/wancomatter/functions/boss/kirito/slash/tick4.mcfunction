...
execute if score @s subcounter matches 1 run scoreboard players remove @s Cooldown6_max 15
...
execute if score @s subcounter matches 5 run scoreboard players add @s Cooldown6_max 25
...
execute if score @s subcounter matches 7 store result score @s Cooldown2_max run data get entity @s Pose.RightArm[1] 1
execute if score @s subcounter matches 7 run scoreboard players operation @s Cooldown4_max = @s Cooldown1_max
execute if score @s subcounter matches 7 run scoreboard players operation @s Cooldown5_max = @s Cooldown2_max
execute if score @s subcounter matches 7 run scoreboard players remove @s Cooldown4_max 30
execute if score @s subcounter matches 7 run scoreboard players add @s Cooldown5_max 5
...
execute if score @s subcounter matches 6..7 run particle minecraft:sweep_attack ^ ^1.2 ^1.2 0.3 0.1 0.3 1 4 force @a
execute if score @s subcounter matches 8..10 run particle minecraft:sweep_attack ^ ^0.5 ^1 0.2 0.1 0.2 1 4 force @a
