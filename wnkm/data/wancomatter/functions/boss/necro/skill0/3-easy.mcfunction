...
tp @s ^ ^ ^0.5
execute positioned ^ ^ ^0.5 run particle minecraft:witch ~ ~1.5 ~ 0.2 0.2 0.2 1 4 normal @a
execute positioned ^ ^ ^-1.0 positioned ~-0.5 ~ ~-0.5 as @a[dx=0,dy=1,dz=0,scores={maxHP=1..}] unless score @s teamNumber = #necroBoss teamNumber run tag @s add hit
