...
execute if score @s counter matches 24 rotated as @e[tag=necro,limit=1] run function wancomatter:boss/necro/skill1/2

execute if score @s counter matches 64.. run kill @s
