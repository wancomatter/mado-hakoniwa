...
scoreboard players remove #dummy Cooldown1 2000
...
execute unless score #difficult counter matches 2..4 run scoreboard players operation #dummy Cooldown1 /= #10 counter
execute if score #difficult counter matches 2 run scoreboard players operation #dummy Cooldown1 /= #8 counter
execute if score #difficult counter matches 3 run scoreboard players operation #dummy Cooldown1 /= #6 counter
execute if score #difficult counter matches 4 run scoreboard players operation #dummy Cooldown1 /= #5 counter

data merge storage wnkm:storage_damage {Damage:1.0f,WeaponNumber:-72,DamageType:2b,isMultiDamage:0b,isKnockbackDamage:1b}
