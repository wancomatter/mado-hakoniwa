...
execute if score @s counter matches 24 run function wancomatter:boss/necro/skill3/2
execute if score @s counter matches 24.. if score @s subcounter2 matches 3.. run function wancomatter:boss/necro/skill3/3

execute unless score @s Mana matches 1.. run kill @s