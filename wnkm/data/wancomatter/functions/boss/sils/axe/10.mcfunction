...
execute as @e[tag=vector] facing entity @s feet positioned 0.0 0.15 0.0 run tp @s ~ ~ ~ ~ 0
...
execute as @e[tag=vector] positioned 0.0 0.0 0.0 facing entity @s feet run tp @s ^ ^ ^1.6
