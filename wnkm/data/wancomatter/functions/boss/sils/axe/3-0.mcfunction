...
execute as @e[tag=axe_target] store result score @s subcounter run data get entity @a[tag=target,limit=1] Pos[0] 290
execute as @e[tag=axe_target] store result score @s subcounter2 run data get entity @a[tag=target,limit=1] Pos[2] 290
