...
scoreboard players add @s Cooldown5_max 10
scoreboard players remove @s Cooldown6_max 20
scoreboard players set @s Cooldown7_max 10


data modify entity @s Pose.LeftLeg set value [10f,0f,0f]
...
execute as @e[tag=vector] store result score @s subcounter run data get entity @a[tag=target,limit=1,sort=nearest] Pos[0] 290
execute as @e[tag=vector] store result score @s subcounter2 run data get entity @a[tag=target,limit=1,sort=nearest] Pos[2] 290
