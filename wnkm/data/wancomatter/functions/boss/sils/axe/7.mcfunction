...
execute unless score #difficult counter matches 4 run data merge entity @s {HandItems:[{},{}]}
execute if score #difficult counter matches 4 run data merge entity @s {HandItems:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:112}},{}]}
...
execute as @e[tag=vector] facing entity @s feet positioned 0.0 0.10 0.0 run tp @s ~ ~ ~ ~ 0
