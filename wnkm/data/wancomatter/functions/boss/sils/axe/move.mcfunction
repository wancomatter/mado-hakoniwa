...
execute unless score #difficult counter matches 2..4 facing entity @a[sort=nearest,limit=1,distance=..48,scores={maxHP=1..}] feet positioned 0.0 0.0 0.0 rotated ~ 0 run summon minecraft:armor_stand ^ ^ ^0.3 {Tags:["vector"],Marker:1b,Invisible:1b,NoGravity:1b}
execute if score #difficult counter matches 2 facing entity @a[sort=nearest,limit=1,distance=..48,scores={maxHP=1..}] feet positioned 0.0 0.0 0.0 rotated ~ 0 run summon minecraft:armor_stand ^ ^ ^0.35 {Tags:["vector"],Marker:1b,Invisible:1b,NoGravity:1b}
execute if score #difficult counter matches 3 facing entity @a[sort=nearest,limit=1,distance=..48,scores={maxHP=1..}] feet positioned 0.0 0.0 0.0 rotated ~ 0 run summon minecraft:armor_stand ^ ^ ^0.40 {Tags:["vector"],Marker:1b,Invisible:1b,NoGravity:1b}
execute if score #difficult counter matches 4 facing entity @a[sort=nearest,limit=1,distance=..48,scores={maxHP=1..}] feet positioned 0.0 0.0 0.0 rotated ~ 0 run summon minecraft:armor_stand ^ ^ ^0.50 {Tags:["vector"],Marker:1b,Invisible:1b,NoGravity:1b}
