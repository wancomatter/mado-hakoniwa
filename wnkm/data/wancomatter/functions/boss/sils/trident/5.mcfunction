...
playsound minecraft:item.trident.riptide_3 master @a ~ ~ ~ 4 0.5
particle minecraft:block ice ~ ~1 ~ 1 1 1 1 150 force @a
particle minecraft:block ice ~ ~1 ~ 1 1 1 1 400 normal @a
