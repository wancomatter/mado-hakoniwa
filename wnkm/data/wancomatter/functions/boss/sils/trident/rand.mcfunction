...
execute if score #dummy dummy matches ..179 run scoreboard players set @s counter 820
execute unless score #dummy dummy matches ..179 run scoreboard players set @s counter 460
