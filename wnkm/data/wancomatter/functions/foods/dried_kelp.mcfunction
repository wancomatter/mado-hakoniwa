...
execute if entity @s[tag=diet] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0.2f,Duration:5,Age:4,WaitTime:1,Particle:"dust 0 0 0 0",Effects:[{Id:27b,Amplifier:0b,Duration:34}]}
