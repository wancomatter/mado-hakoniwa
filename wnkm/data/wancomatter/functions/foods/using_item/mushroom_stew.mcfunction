...
execute if entity @s[tag=diet] run scoreboard players set #dummy HPheal 160
...
clear @s mushroom_stem
advancement revoke @s only wancomatter:foods/using_item/mushroom_stew