...
execute if score @s teleporter matches 20.. if score #stagechanged subcounter matches 4 run tp @s ~ ~6 ~
execute if score @s teleporter matches 20.. if score #stagechanged subcounter matches 5 run tp @s ~ 28 ~
