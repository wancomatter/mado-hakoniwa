...
execute unless entity @s[tag=bless_of_hunger2] if data entity @s {ActiveEffects:[{Id:27,Ambient:0b}]} store result entity @e[tag=this,limit=1] Effects[{Id:27}].Duration int 0.666667 run data get entity @s ActiveEffects[{Id:27,Ambient:0b}].Duration 1
execute if entity @s[tag=bless_of_hunger2] if data entity @s {ActiveEffects:[{Id:27,Ambient:0b}]} store result entity @e[tag=this,limit=1] Effects[{Id:27}].Duration int 0.444444 run data get entity @s ActiveEffects[{Id:27,Ambient:0b}].Duration 1
