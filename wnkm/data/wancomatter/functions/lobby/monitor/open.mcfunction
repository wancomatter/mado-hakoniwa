...
summon minecraft:slime 0 -10 0 {Tags:["monitorUIslime"],Size:4,NoAI:1b,Silent:1b,DeathLootTable:"empty",ActiveEffects:[{Id:11,Amplifier:0b,Duration:2147483647,ShowParticles:0b},{Id:14,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Team:"noPush"}
