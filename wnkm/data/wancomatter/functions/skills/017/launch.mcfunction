...
execute positioned ~-0.05 ~-0.05 ~-0.05 as @e[dx=0,scores={maxHP=1..}] unless score @s teamNumber = @e[tag=now-Braze,limit=1] teamNumber positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run tag @s add Braze-hit
