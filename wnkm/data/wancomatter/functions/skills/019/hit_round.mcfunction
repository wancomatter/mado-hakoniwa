data merge storage wnkm:storage_damage {Damage:2.5f,WeaponNumber:19,DamageType:1b,isMultiDamage:1b,isKnockbackDamage:1b}
...
scoreboard players set @s subcounter2 10