...
execute positioned ~-0.30 ~-0.30 ~-0.30 as @e[dx=0,scores={maxHP=1..}] positioned ~-0.4 ~-0.4 ~-0.4 if entity @s[dx=0] unless score @s teamNumber = #dummy teamNumber run tag @s add hit
