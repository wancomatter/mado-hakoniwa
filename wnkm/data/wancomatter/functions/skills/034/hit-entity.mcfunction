...
execute as @e[tag=GreL-hit] at @e[tag=GreL_discharge] at @e[tag=GreL_discharge] at @e[tag=GreL_discharge] at @e[tag=GreL_discharge] at @s facing entity @e[tag=GreL_discharge,limit=1,sort=nearest] feet rotated ~ 0 run summon minecraft:slime ^ ^ ^0.2 {Size:0,NoAI:1b,DeathTime:16s,Silent:1b,Tags:["034slime"],ActiveEffects:[{Id:14b,Duration:2147483647,ShowParticles:0b}]}
#execute as @e[tag=GreL-hit] at @e[tag=GreL_discharge] at @e[tag=GreL_discharge] at @s facing entity @e[tag=GreL_discharge,limit=1,sort=nearest] feet rotated ~ 0 run summon minecraft:slime ^ ^ ^0.2 {Size:0,NoAI:1b,DeathTime:16s,Silent:1b,Tags:["kill"],ActiveEffects:[{Id:14b,Duration:2147483647,ShowParticles:0b}]}
execute as @e[tag=GreL-hit] at @e[tag=GreL_discharge] as @s at @s rotated ~ 0 run summon minecraft:slime ^ ^ ^0.2 {Size:0,NoAI:1b,DeathTime:16s,Silent:1b,Tags:["034slime"],ActiveEffects:[{Id:14b,Duration:2147483647,ShowParticles:0b}]}
