...
execute as @e[tag=discharge] at @s run function wancomatter:skills/047/move
...
execute unless score #dummy counter matches ..133 run scoreboard players remove @s Mana 12
