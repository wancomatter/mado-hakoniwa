...
execute at @s anchored eyes run execute anchored eyes run summon minecraft:potion ^ ^ ^ {Fire:32767s,Tags:["this"],Item:{id:"minecraft:lingering_potion",Count:1b,tag:{CustomPotionColor:65280,CustomPotionEffects:[{Id:31,Amplifier:49b,ShowParticles:0b,Duration:1}]}}}
