...
execute anchored eyes run summon minecraft:arrow ^ ^ ^0.1 {Tags:["discharge","wind_arrow"],life:1200s,damage:1.1d,CustomPotionEffects:[{Id:25,Amplifier:10b,Duration:8}],Color:5635925}
