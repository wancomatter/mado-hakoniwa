...
execute at @s anchored eyes run execute anchored eyes run summon minecraft:potion ^ ^ ^ {Fire:2s,Tags:["this"],Item:{id:"minecraft:lingering_potion",Count:1b,tag:{CustomPotionColor:15592941,CustomPotionEffects:[{Id:31b,Amplifier:58b,ShowParticles:0b,Duration:1}]}}}
