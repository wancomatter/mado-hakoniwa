...
execute if score @s subcounter matches 1.. run scoreboard players remove @s Cooldown5 2
execute if score @s subcounter matches 1.. run scoreboard players operation @s Cooldown3 += @s Cooldown5
