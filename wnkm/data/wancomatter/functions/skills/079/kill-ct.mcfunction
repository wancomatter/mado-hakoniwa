scoreboard players set @s dummy 141
scoreboard players operation @s dummy *= @s statCTAmount
scoreboard players operation @s dummy /= #1000 counter
execute if score @s s79slot matches 0 run scoreboard players operation @s Cooldown1 += @s dummy
execute if score @s s79slot matches 0 run scoreboard players operation @s Cooldown1_max = @s Cooldown1
execute if score @s s79slot matches 1 run scoreboard players operation @s Cooldown2 += @s dummy
execute if score @s s79slot matches 1 run scoreboard players operation @s Cooldown2_max = @s Cooldown2
execute if score @s s79slot matches 2 run scoreboard players operation @s Cooldown3 += @s dummy
execute if score @s s79slot matches 2 run scoreboard players operation @s Cooldown3_max = @s Cooldown3
execute if score @s s79slot matches 3 run scoreboard players operation @s Cooldown4 += @s dummy
execute if score @s s79slot matches 3 run scoreboard players operation @s Cooldown4_max = @s Cooldown4
execute if score @s s79slot matches 4 run scoreboard players operation @s Cooldown5 += @s dummy
execute if score @s s79slot matches 4 run scoreboard players operation @s Cooldown5_max = @s Cooldown5
execute if score @s s79slot matches 5 run scoreboard players operation @s Cooldown6 += @s dummy
execute if score @s s79slot matches 5 run scoreboard players operation @s Cooldown6_max = @s Cooldown6
execute if score @s s79slot matches 6 run scoreboard players operation @s Cooldown7 += @s dummy
execute if score @s s79slot matches 6 run scoreboard players operation @s Cooldown7_max = @s Cooldown7
execute if score @s s79slot matches 7 run scoreboard players operation @s Cooldown8 += @s dummy
execute if score @s s79slot matches 7 run scoreboard players operation @s Cooldown8_max = @s Cooldown8
execute if score @s s79slot matches 8 run scoreboard players operation @s Cooldown9 += @s dummy
execute if score @s s79slot matches 8 run scoreboard players operation @s Cooldown9_max = @s Cooldown9

data modify storage wnkm:work Items set from entity @s Inventory
execute store result storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:79}}].tag.usedSkillSlot byte 1 run scoreboard players get @s s79slot
