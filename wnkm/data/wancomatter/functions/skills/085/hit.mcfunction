...
#execute if data entity @s ActiveEffects[{Id:19}] run data modify storage wnkm:storage_damage Damage set value 8.0f
...
execute unless data entity @s ActiveEffects[{Id:19}] run scoreboard players set @s damageTaken 40
execute if data entity @s ActiveEffects[{Id:19}] run scoreboard players set @s damageTaken 80
