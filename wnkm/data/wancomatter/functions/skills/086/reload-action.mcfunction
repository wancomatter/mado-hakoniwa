...
execute unless entity @s[tag=!extend_magazine1,tag=!extend_magazine2] store result block 0 0 0 Items[0].tag.Ammo int 1.5 run data get entity @s SelectedItem.tag.AmmoMax 1.00
data modify block 0 0 0 Items[0].tag.CustomModelData set value 86
...
scoreboard players set @s CooldownX 26
scoreboard players set @s CooldownX_max 26
