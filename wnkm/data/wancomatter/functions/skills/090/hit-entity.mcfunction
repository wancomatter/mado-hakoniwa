...
execute at @e[tag=hit] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:5,Age:4,WaitTime:1,Radius:0.4f,Particle:"dust 0 0 0 0",Effects:[{Id:25b,Amplifier:10b,Duration:6,ShowParticles:0b}]}
