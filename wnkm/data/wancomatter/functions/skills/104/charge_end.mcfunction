...
data remove storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:104}}].tag.AttributeModifiers[{UUID:[I;104,-104,104,104],AttributeName:"minecraft:generic.attack_speed",Name:"generic.attack_speed"}]
data remove storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:104}}].tag.AttributeModifiers[{UUID:[I;104,104,104,104],AttributeName:"minecraft:generic.attack_damage",Name:"generic.attack_damage"}]
data modify storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:104}}].id set value diamond_sword
