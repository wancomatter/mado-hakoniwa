...
data remove storage wnkm:work Items[{id:"minecraft:ender_eye",tag:{CustomModelData:114}}].tag.AttributeModifiers[{UUID:[I;114,-114,114,114],AttributeName:"minecraft:generic.attack_speed",Name:"generic.attack_speed"}]
data remove storage wnkm:work Items[{id:"minecraft:ender_eye",tag:{CustomModelData:114}}].tag.AttributeModifiers[{UUID:[I;114,114,114,114],AttributeName:"minecraft:generic.attack_damage",Name:"generic.attack_damage"}]
data modify storage wnkm:work Items[{id:"minecraft:ender_eye",tag:{CustomModelData:114}}].id set value carrot_on_a_stick
