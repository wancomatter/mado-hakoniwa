...
data modify storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:118}}].tag.usedSkillSlot set from storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:118}}].tag.117.usedSkillSlot
data remove storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:118}}].tag.117
data modify storage wnkm:work Items[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:118}}].tag.CustomModelData set value 117
...
execute store result score #dummy dummy run data get entity @s Inventory[{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}].Slot 1
...
execute unless score #dummy dummy matches 1.. if data entity @s {Inventory:[{Slot:1b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 1
...
execute unless score #dummy dummy matches 2.. if data entity @s {Inventory:[{Slot:2b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 2
...
execute unless score #dummy dummy matches 3.. if data entity @s {Inventory:[{Slot:3b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 3
...
execute unless score #dummy dummy matches 4.. if data entity @s {Inventory:[{Slot:4b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 4
...
execute unless score #dummy dummy matches 5.. if data entity @s {Inventory:[{Slot:5b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 5
...
execute unless score #dummy dummy matches 6.. if data entity @s {Inventory:[{Slot:6b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 6
...
execute unless score #dummy dummy matches 7.. if data entity @s {Inventory:[{Slot:7b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 7
...
execute unless score #dummy dummy matches 8.. if data entity @s {Inventory:[{Slot:8b,id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:117}}]} run scoreboard players set #dummy dummy 8
