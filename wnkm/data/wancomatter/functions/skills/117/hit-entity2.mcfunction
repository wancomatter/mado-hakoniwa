...
execute if score #dummy Cooldown1 matches 400.. run scoreboard players set #dummy Cooldown1 400
...
particle block tube_coral_block ~ ~ ~ 1 1 1 1 100 normal @a
particle block tube_coral_block ~ ~ ~ 1 1 1 1 25 force @a
...
scoreboard players set @s counter 300
