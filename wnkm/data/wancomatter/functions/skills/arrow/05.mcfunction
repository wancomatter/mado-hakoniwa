...
execute positioned as @s run playsound minecraft:entity.illusioner.mirror_move master @a ~ ~ ~ 1.2 0.8
...
execute if entity @s[tag=arrow_offgive] run loot replace entity @s weapon.offhand loot wancomatter:skills/arrow/seima
execute unless entity @s[tag=arrow_offgive] run loot give @s loot wancomatter:skills/arrow/seima
execute if entity @s[tag=extend_quiver] run loot give @s loot wancomatter:skills/arrow/1_seima
execute if entity @s[tag=extend_quiver] run loot give @s loot wancomatter:skills/arrow/1_seima
