...
execute positioned as @s run playsound minecraft:entity.tnt.primed master @a ~ ~ ~ 1.2 1
...
execute if entity @s[tag=arrow_offgive] run loot replace entity @s weapon.offhand loot wancomatter:skills/arrow/1_bomb
execute unless entity @s[tag=arrow_offgive] run loot give @s loot wancomatter:skills/arrow/1_bomb
