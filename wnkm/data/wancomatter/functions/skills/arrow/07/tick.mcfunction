...
execute as @e[tag=meteor_arrow_AEC] if score @s subcounter2 = #dummy subcounter2 run kill @s
summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["this","meteor_arrow_AEC"],Duration:3,Radius:0f}
