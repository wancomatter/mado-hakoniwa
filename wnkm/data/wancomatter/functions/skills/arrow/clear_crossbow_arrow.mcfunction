...
data remove storage wnkm:work Items[{id:"minecraft:crossbow",tag:{Charged:1b}}].tag.bowgunStorage
data modify storage wnkm:work Items[{id:"minecraft:crossbow",tag:{Charged:1b}}].tag.bowgunCharged set value 0b
data modify storage wnkm:work Items[{id:"minecraft:crossbow",tag:{Charged:1b}}].tag.Unbreakable set value 1b
data remove storage wnkm:work Items[{id:"minecraft:crossbow",tag:{Charged:1b}}].tag.ChargedProjectiles
data remove storage wnkm:work Items[{id:"minecraft:crossbow",tag:{Charged:1b}}].tag.Charged

execute if data storage wnkm:work Items[{id:"minecraft:crossbow",tag:{bowgun:1b}}] run data modify storage wnkm:work Items[{id:"minecraft:crossbow",tag:{bowgun:1b,bowgunCharged:2b}}].tag.bowgunCharged set value 0b
