...
execute if entity @s[scores={dummy=131}] as @e[tag=first] store result entity @s damage double 0.01 run data get entity @s damage 125
...
execute if entity @s[scores={dummy=133}] as @e[tag=first] store result entity @s damage double 0.01 run data get entity @s damage 110
