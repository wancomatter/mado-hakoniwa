...
data remove storage wnkm:work Items[{id:"minecraft:spyglass",tag:{CustomModelData:132}}].tag.ChargedProjectiles
data remove storage wnkm:work Items[{id:"minecraft:spyglass",tag:{CustomModelData:132}}].tag.Charged
data modify storage wnkm:work Items[{id:"minecraft:spyglass",tag:{CustomModelData:132}}].id set value crossbow
...
tag @s remove has_charged_ballista
