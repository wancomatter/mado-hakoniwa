...
execute as @e[tag=hit] at @e[tag=ks_AEC] at @s facing entity @e[tag=ks_AEC,limit=1,sort=nearest] feet rotated ~ 0 run summon minecraft:slime ^ ^ ^0.2 {Size:0,NoAI:1b,DeathTime:18s,Silent:1b,Tags:["kill"],ActiveEffects:[{Id:14,Duration:2147483647,ShowParticles:0b}]}
